...
function Invoke-AnalyzerBuild {
	...
	# rimosso temporaneamente $tempEditorConfigContent = Get-Content -LiteralPath $editorConfigPath -Raw
	$tempEditorConfigContent = @" 
# Temporary override generated by start-analyze-dotnet.ps1 - DO NOT COMMIT 
# Demotes error-severity diagnostics to warnings so every project compiles and 
# produces a DLL, allowing dependent projects to be analyzed as well. 
[*.cs] 
